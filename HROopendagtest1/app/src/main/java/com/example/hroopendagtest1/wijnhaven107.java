...
public class wijnhaven107 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ImageView Floor;
    Button Button_GF;
    Button Button_FF;
    Button Button_SF;
...
//https://www.youtube.com/watch?v=STCsL3bfwxI
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wijnhaven107);
        ...
        Button_GF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1070);
        ...
        Button_FF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1071);
        ...
        Button_SF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1072);
        ...
        Button_TF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1073);
