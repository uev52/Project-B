...
public class quiz_CAMD extends AppCompatActivity
    ...
    int [] pointsPerQuestion = new int[quizLibr.camdQuestions.length+1];
    int[] selectedAnswers = new int[quizLibr.camdQuestions.length+1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (questionNumber!= quizLibr.camdQuestions.length){
                    ...
                    activeBtn();
                    colorBtn();
                    System.out.println(quizLibr.camdQuestions.length);
