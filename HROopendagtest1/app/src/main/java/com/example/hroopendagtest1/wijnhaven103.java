...
public class wijnhaven103 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ImageView Floor;
    Button Button_GF;
    Button Button_FF;
    Button Button_SF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wijnhaven103);
        ...
        Button_GF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1074);
        ...
        Button_FF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1075);
        ...
        Button_TF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Floor.setImageResource(R.drawable.cmi1077);
